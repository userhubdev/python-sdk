...
from ._plan_savings import PlanSavings
...
class Plan:
    ...
    savings: Optional[PlanSavings] = None
    ...
    def __json_encode__(self) -> Dict[str, Any]:
        ...
        if self.savings is not None:
            data["savings"] = PlanSavings.__json_encode__(self.savings)
    ...
    def __json_decode__(data: Dict[str, Any]) -> "Plan":
        ...
        if data.get("savings") is not None:
            kwargs["savings"] = PlanSavings.__json_decode__(data["savings"])
